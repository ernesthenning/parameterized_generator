...
def generate():
    ...
    gen = Generator(length_points=18001,
                    ...
                    bias_max_intensity=0.1,
                    bias_min_intensity=0.03,
                    bias_peaks_number=30,
                    bias_max_peak_width=150,
                    bias_min_peak_width=30,
                    peaks_probe_number=1,
                    widths_probe=np.array([[300], [300], [300], [300], [300]]),
                    intensities_probe_peaks=np.array([[6], [9.6], [12], [18], [24]]),
                    times_probe_peaks=np.array([[14900], [14900], [14900], [14900], [14900]]),
                    repeatability=0.13,
                    ...
                    probes_count=5,
                    start_time='10:02',
                    interval_between_chromatograms=35,
                    cyctime=0.1,
                    coef=0.0003,
                    units='mV',
                    analysis_date='11.11.2024')
    gen.get_exported_chromatograms()
    gen.generate_bats("11.11.2024")
